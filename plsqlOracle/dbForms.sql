...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."ALUMNOS" 
   (	"ID_ALUMNO" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."AULAS" 
   (	"ID_AULA" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"NOMBRE_AULA" VARCHAR2(50 BYTE), 
	"CAPACIDAD" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."CURSOS" 
   (	"ID_CURSO" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"NOMBRE_CURSO" VARCHAR2(100 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."DOCENTES" 
   (	"ID_DOCENTE" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"NOMBRE" VARCHAR2(100 BYTE), 
	"APELLIDO" VARCHAR2(100 BYTE), 
	"DNI" VARCHAR2(20 BYTE), 
	"TELEFONO" VARCHAR2(20 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."HORARIOS" 
   (	"ID_HORARIO" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"ID_CURSO" NUMBER, 
	"ID_MATERIA" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."INSCRIPCIONES" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."MATERIAS" 
   (	"ID_MATERIA" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."NOTAS" 
   (	"ID_NOTA" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"ID_ALUMNO" NUMBER, 
	"ID_MATERIA" NUMBER, 
...
SET DEFINE OFF;
Insert into SYSTEM.ALUMNOS (ID_ALUMNO,NOMBRE,APELLIDO,DNI,FECHA_NACIMIENTO,DIRECCION,TELEFONO,EMAIL) values ('1','pepe','DAVINI','1234',to_date('05/06/91','DD/MM/RR'),'AV. SIEMPRE VIVA 1234','1144556677','MAXIMILIANO@MAIL.COM');
Insert into SYSTEM.ALUMNOS (ID_ALUMNO,NOMBRE,APELLIDO,DNI,FECHA_NACIMIENTO,DIRECCION,TELEFONO,EMAIL) values ('3','sadasd','asdasd','445534',to_date('01/05/20','DD/MM/RR'),'asd','123123','asd@asd.com');
Insert into SYSTEM.ALUMNOS (ID_ALUMNO,NOMBRE,APELLIDO,DNI,FECHA_NACIMIENTO,DIRECCION,TELEFONO,EMAIL) values ('2','asdasd','sadasd','123454',to_date('01/01/20','DD/MM/RR'),'SADASD 4545','545456','asd@gma.com');
Insert into SYSTEM.ALUMNOS (ID_ALUMNO,NOMBRE,APELLIDO,DNI,FECHA_NACIMIENTO,DIRECCION,TELEFONO,EMAIL) values ('4','ASDASD','ASDASD','33333',to_date('01/01/25','DD/MM/RR'),'EWQE','123123','ASD@SAD.COM');
Insert into SYSTEM.ALUMNOS (ID_ALUMNO,NOMBRE,APELLIDO,DNI,FECHA_NACIMIENTO,DIRECCION,TELEFONO,EMAIL) values ('5','JAMON','CRUDO','12345678',to_date('12/05/91','DD/MM/RR'),'ASDASD 123','44445555','UN@MAIL.COM');
...
SET DEFINE OFF;
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DBD8012EE053F706E80A06B7','19725','AQ$_SCHEDULER$_EVENT_QTAB_E','19703','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DBD9012EE053F706E80A06B7','19726','SCHEDULER$_EVENT_QUEUE','19703','0','3','5','0','0','3600','Scheduler event queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DBDB012EE053F706E80A06B7','19759','AQ$_SCHEDULER$_REMDB_JOBQTAB_E','19730','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DBDC012EE053F706E80A06B7','19760','SCHEDULER$_REMDB_JOBQ','19730','0','3','5','0','0','0','Scheduler remote db job queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DBDE012EE053F706E80A06B7','19789','AQ$_SCHEDULER_FILEWATCHER_QT_E','19764','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DBDF012EE053F706E80A06B7','19790','SCHEDULER_FILEWATCHER_Q','19764','0','3','5','0','0','0','Scheduler file watcher results queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DBE0012EE053F706E80A06B7','19844','AQ$_ALERT_QT_E','19822','1','2','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DBE1012EE053F706E80A06B7','19845','ALERT_QUE','19822','0','3','5','0','0','0','Server Generated Alert Queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DBE2012EE053F706E80A06B7','20145','AQ$_ORA$PREPLUGIN_BACKUP_QTB_E','20123','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DBE3012EE053F706E80A06B7','20146','ORA$PREPLUGIN_BACKUP_QUE','20123','0','3','5','0','0','0','SYS.ORA$PREPLUGIN_BACKUP_QUE',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DD09012EE053F706E80A06B7','20365','AQ$_AQ$_MEM_MC_E','20341','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DD0A012EE053F706E80A06B7','20366','SRVQUEUE','20341','2','3','0','0','0','0',null,null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DD0B012EE053F706E80A06B7','20377','AQ$_AQ_EVENT_TABLE_E','20367','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DD0C012EE053F706E80A06B7','20378','AQ_EVENT_TABLE_Q','20367','0','3','5','0','0','0','CREATING AQ_EVENT_TABLE_Q QUEUE',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DD0D012EE053F706E80A06B7','20401','AQ$_AQ_PROP_TABLE_E','20379','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DD0E012EE053F706E80A06B7','20402','AQ_PROP_NOTIFY','20379','0','3','5','0','0','0','Queue for Notifying events in AQ Prop. Scheduling',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DD0F012EE053F706E80A06B7','20422','AQ$_CQN_EVENT_TABLE_E','20412','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DD10012EE053F706E80A06B7','20423','CQN_EVENT_TABLE_Q','20412','0','3','5','0','0','0','CREATING CQN_EVENT_TABLE_Q QUEUE',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DE2F012EE053F706E80A06B7','20734','AQ$_SYS$SERVICE_METRICS_TAB_E','20712','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DE30012EE053F706E80A06B7','20735','SYS$SERVICE_METRICS','20712','0','3','5','0','0','3600',null,null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DF8E012EE053F706E80A06B7','20903','AQ$_PDB_MON_EVENT_QTABLE$_E','20879','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DF8F012EE053F706E80A06B7','20904','PDB_MON_EVENT_QUEUE$','20879','0','3','5','0','0','86400','Queue for raw pdb event information',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DF93012EE053F706E80A06B7','21045','AQ$_CHANGE_LOG_QUEUE_TABLE_E','21023','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B64B66DF94012EE053F706E80A06B7','21046','CHANGE_LOG_QUEUE','21023','0','3','5','0','0','0','GSM Change Log Queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B6D50DCCAD25C0E053F706E80AAB0A','22781','AQ$_WM$EVENT_QUEUE_TABLE_E','22754','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0','0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED,BASE_QUEUE) values ('86B6D50DCCAE25C0E053F706E80AAB0A','22782','WM$EVENT_QUEUE','22754','0','3','5','0','0','0','OWM Events Queue',null,null,null,null,null,'0','0');
REM INSERTING into SYSTEM.AQ$_QUEUE_TABLES
SET DEFINE OFF;
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','SCHEDULER$_EVENT_QTAB','1','19703','16805897','2','00:00','Scheduler event queue table');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','SCHEDULER$_REMDB_JOBQTAB','1','19730','16801801','2','00:00','Scheduler remote db job queue table');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','SCHEDULER_FILEWATCHER_QT','1','19764','16805897','2','00:00','Scheduler file watcher result queue table');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','ALERT_QT','1','19822','16805897','2','00:00','Server Generated Alert Queue Table');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','ORA$PREPLUGIN_BACKUP_QTB','1','20123','16801801','2','00:00','SYS.ORA$PREPLUGIN_BACKUP_QUE');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','AQ$_MEM_MC','3','20341','16801801','2','00:00','table for non_persistent queues');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','AQ_EVENT_TABLE','1','20367','16793600','2','00:00','CREATING AQ_EVENT_TABLE QUEUE TABLE');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','AQ_PROP_TABLE','1','20379','16801801','2','00:00','Queue Table for Notification in AQ Prop. Scheduling');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','CQN_EVENT_TABLE','1','20412','16793600','2','00:00','CREATING CQN_EVENT_TABLE QUEUE TABLE');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','SYS$SERVICE_METRICS_TAB','1','20712','16801801','2','00:00',null);
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('SYS','PDB_MON_EVENT_QTABLE$','1','20879','16801801','2','00:00','Raw queue table containing event information');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('GSMADMIN_INTERNAL','CHANGE_LOG_QUEUE_TABLE','1','21023','16801801','2','00:00','Creating GSM change log queue table');
Insert into SYSTEM.AQ$_QUEUE_TABLES (SCHEMA,NAME,UDATA_TYPE,OBJNO,FLAGS,SORT_COLS,TIMEZONE,TABLE_COMMENT) values ('WMSYS','WM$EVENT_QUEUE_TABLE','1','22754','16801801','2','00:00',null);
REM INSERTING into SYSTEM.AQ$_SCHEDULES
SET DEFINE OFF;
REM INSERTING into SYSTEM.AULAS
SET DEFINE OFF;
REM INSERTING into SYSTEM.CURSOS
SET DEFINE OFF;
REM INSERTING into SYSTEM.DOCENTES
SET DEFINE OFF;
...
REM INSERTING into SYSTEM.HORARIOS
SET DEFINE OFF;
REM INSERTING into SYSTEM.INSCRIPCIONES
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.MATERIAS
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.NOTAS
SET DEFINE OFF;
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Procedure OPEN_FORM
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."OPEN_FORM" 
...
/
--------------------------------------------------------
--  DDL for Package PACKAGE_ALUMNOS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE "SYSTEM"."PACKAGE_ALUMNOS" 
IS
    -- TIPO DE DATOS
	TYPE tipoDatos is record (
	idUsuario  ALUMNOS.ID_ALUMNO%TYPE,
	nombre	   ALUMNOS.NOMBRE%TYPE,
	apellido   ALUMNOS.APELLIDO%TYPE,
    dni        ALUMNOS.DNI%TYPE,
	fnacimien  ALUMNOS.FECHA_NACIMIENTO%TYPE,
	direccion  ALUMNOS.DIRECCION%TYPE,
...
/
--------------------------------------------------------
--  DDL for Package Body PACKAGE_ALUMNOS
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CURSOS" MODIFY ("ID_CURSO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CURSOS" ADD PRIMARY KEY ("ID_CURSO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MATERIAS" MODIFY ("ID_MATERIA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MATERIAS" ADD PRIMARY KEY ("ID_MATERIA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ALUMNOS" MODIFY ("ID_ALUMNO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ALUMNOS" ADD PRIMARY KEY ("ID_ALUMNO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."ALUMNOS" ADD UNIQUE ("DNI")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DOCENTES" MODIFY ("ID_DOCENTE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DOCENTES" ADD PRIMARY KEY ("ID_DOCENTE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."DOCENTES" ADD UNIQUE ("DNI")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."HORARIOS" MODIFY ("ID_HORARIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HORARIOS" ADD PRIMARY KEY ("ID_HORARIO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."NOTAS" MODIFY ("ID_NOTA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."NOTAS" ADD PRIMARY KEY ("ID_NOTA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."INSCRIPCIONES" MODIFY ("ID_INSCRIPCION" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."INSCRIPCIONES" ADD PRIMARY KEY ("ID_INSCRIPCION")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."AULAS" MODIFY ("ID_AULA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AULAS" ADD PRIMARY KEY ("ID_AULA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."HORARIOS" ADD FOREIGN KEY ("ID_CURSO")
	  REFERENCES "SYSTEM"."CURSOS" ("ID_CURSO") ENABLE;
  ALTER TABLE "SYSTEM"."HORARIOS" ADD FOREIGN KEY ("ID_MATERIA")
	  REFERENCES "SYSTEM"."MATERIAS" ("ID_MATERIA") ENABLE;
  ALTER TABLE "SYSTEM"."HORARIOS" ADD FOREIGN KEY ("ID_AULA")
	  REFERENCES "SYSTEM"."AULAS" ("ID_AULA") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table INSCRIPCIONES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."INSCRIPCIONES" ADD FOREIGN KEY ("ID_ALUMNO")
	  REFERENCES "SYSTEM"."ALUMNOS" ("ID_ALUMNO") ENABLE;
  ALTER TABLE "SYSTEM"."INSCRIPCIONES" ADD FOREIGN KEY ("ID_CURSO")
	  REFERENCES "SYSTEM"."CURSOS" ("ID_CURSO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table MATERIAS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."MATERIAS" ADD FOREIGN KEY ("ID_CURSO")
	  REFERENCES "SYSTEM"."CURSOS" ("ID_CURSO") ENABLE;
  ALTER TABLE "SYSTEM"."MATERIAS" ADD FOREIGN KEY ("ID_DOCENTE")
	  REFERENCES "SYSTEM"."DOCENTES" ("ID_DOCENTE") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."NOTAS" ADD FOREIGN KEY ("ID_ALUMNO")
	  REFERENCES "SYSTEM"."ALUMNOS" ("ID_ALUMNO") ENABLE;
  ALTER TABLE "SYSTEM"."NOTAS" ADD FOREIGN KEY ("ID_MATERIA")
	  REFERENCES "SYSTEM"."MATERIAS" ("ID_MATERIA") ENABLE;
